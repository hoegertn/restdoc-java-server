...
public interface IRestDocGeneratorExtension {
	 ...
	 * @param definition the {@link ParamDefinition}
	 ...
	 * 
	 * @param name the parameter name
	 * @param definition the {@link HeaderDefinition}
	 * @param paramType the Java class of the parameter
	 * @param map the map of annotations
	 */
	 ...
	 * 
	 * @param restResource the super resource
	 * @param def the {@link MethodDefinition}
